...
try {
  ...
  console.log('Connected BLACK-HUNTER-MD database \u2714️')
} catch {
  console.log(
    'Could not connect with Mongodb \u274C please visit https://mongodb.com/'
  )
  process.exit(0)
}
...
const _0x119cd3 = {}
_0x119cd3.numbers = ['94758179948']
_0x119cd3.react = '\uD83D\uDC68‍\uD83D\uDCBB'
const _0x3eab99 = {}
_0x3eab99.numbers = ['94712461421']
_0x3eab99.react = '\u2696️'
...
setTimeout(() => {
  ...
  async function _0x5c4629() {
    ...
    try {
      ...
      console.log(
        'Could not connect with Mongodb.\u274C\nPlease visit https://mongodb.com/'
      )
    }
  }
  _0x5c4629()
  ...
  async function _0x12cf82() {
    ...
    const { state: _0x29101e, saveCreds: _0x490969 } =
      ...
      _0x3f593f = VoidConnect({
        ...
        browser: ['HUNTER-MD', 'Safari', '1.0.0'],
    ...
    _0x3f593f.ev.on('messages.upsert', async (_0x2dd90a) => {
      ...
      try {
        ...
        const _0x227b84 = _0x4ea58a.body
          ...
          _0x235e5d = '94758179948,94712461421',
        ...
        const _0x10ea42 = _0x2752c7,
          ...
          _0x36a6a3 =
            'https://gist.github.com/MR-KALINDU/e2111423feb44e917468d08b2460f318',
        ...
        if (_0x4ea58a.chat === '120363162305531586@g.us') {
          return
        }
        if (_0x4ea58a.chat === '120363162305531586@g.us') {
          return
        ...
        if (_0x3f03f2 && _0x316f90) {
          _0x4ea58a.reply(
            '*Your number has been banned by BLACK-HUNTER owners.* \u26D4'
          )
          setTimeout(function () {
